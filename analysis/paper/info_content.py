...
# ------------------------------------------------------------------ dataset assembly --------------------- #
# The binning primitive moved to adonis/analysis/binning.py -- it was core machinery living in
# the application layer, imported by adonis.fit.  Re-exported so paper-side callers keep working.
from adonis.analysis.binning import (BinSpec, spec_of, bin_w0, bin_w, bin_w0_dev,  # noqa: F401
                                     bin_w_dev, _bin)

...
from analysis.paper.physical_fit import PNAMES, PRIOR, NPAR, build_physfit_datasets, theta_nominal, SYST
...
PROVENANCE. All results reproducible from the branch: analysis/paper/physical_fit.py (Gate I),

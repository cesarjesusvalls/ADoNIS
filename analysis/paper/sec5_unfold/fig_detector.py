...
def main(label="sec5"):
    ...
    im = ax.imshow(P, aspect="auto", origin="lower", cmap="viridis", interpolation="nearest")
    ...
    ax.set_title("(a) response", fontsize=9, loc="left")
    ...
    ax.set_title("(b) efficiency", fontsize=9, loc="left")
    ...
    ax.set_title("(c) purity", fontsize=9, loc="left")

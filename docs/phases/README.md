...
| [PHASE_B.md](PHASE_B.md) | B — QE vertex + inclusive (e,e′) | ☑ B1 CCQE <0.5% abs; B2/B3 inclusive (e,e′) QE+1π (Fig 1, ¹²C+⁴⁰Ar); validated vs ACHILLES (e,e′) oracles w/ ratio+χ²: 1π χ²/ndf~15 (binding fix), QE χ²/ndf~28 (~35 MeV PWIA-prescription offset) |

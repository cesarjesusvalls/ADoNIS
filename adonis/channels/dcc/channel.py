...
from adonis.channels.dcc.lepton import cm_lepton_momenta, lepton_tensor_cc, lepton_tensor_em, contract
...
def weight_from_sample(knobs: DCCKnobs, S, use_spline=True):
    ...
    use_spline=False interpolates the amplitude table bilinearly, which does not follow dsigma/dW
    through the high-W tail; the spline does."""
    hs = S["hs"]
...
class DCCSinglePion(Channel):
    ...
    def __init__(self, cfg: ChainConfig = ChainConfig(), hs: HadronStructure | None = None,

...
from .hadron_tensor import cbg
from .hadron_assembly import (IGM1_LIST, LAM_LIST, ISF_LIST, _IXI1_OF, pw_phase)
...
def build_zmtx_batched(vec, isv, axial, W, Q2, two_J, two_L, two_I, *, mode, itiz,
    ...
    # vector current with EW isospin rotation (weak: I=1/2 -> (V-IS)/2; I=3/2 raw)
    if mode < 10:

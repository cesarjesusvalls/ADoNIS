...
gen gen_c_res_cv5      # builds the larger material-keyed grid res_vegasgrid_C.npz, then 5 seeds
gen gen_c_qe_cv5       # 5 seeds, no grid
for c in ana_cc0pi_qeonly_cv5 ana_cc0pi_cv5 ana_cc0pi_0p_cv5 ana_cc0pi_1p_cv5 ana_cc0pi_2p_cv5 \
         ana_cc1pi_resonly_cv5 ana_cc1pi_cv5; do ana "$c"; done
echo "CV5 ALL DONE $(date '+%F %T')" >> "$LOG"
